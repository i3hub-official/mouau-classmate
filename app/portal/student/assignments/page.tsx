// app/portal/student/assignments/page.tsx
  ...
  return (
    <div className="container mx-auto py-6 space-y-6">
      ...
      <div className="rounded-lg border bg-card p-6">
        ...
        <form
          action="/portal/student/assignments"
          method="GET"
        ...
        >
          ...
          <div className="flex items-end">
            <button
              type="button"
              onClick={() =>
                (window.location.href = "/portal/student/assignments")
              }
              ...
              <button
                onClick={() => {
                  ...
                  if (page > 1) {
                    ...
                    window.location.href = `/portal/student/assignments?${params.toString()}`;
                  }
                }}
            ...
            {hasSubmitted ? (
              <button
                onClick={() => {
                  ...
                  window.location.href = `/portal/student/assignments/${assignment.id}/submission`;
                }}
                className="inline-flex items-center justify-center rounded-md border border-input bg-background hover:bg-accent hover:text-accent-foreground h-8 px-3 py-2"
              >
              ...
              <button
                onClick={() => {
                  // Submit assignment
                  window.location.href = `/portal/student/assignments/${assignment.id}/submit`;
                }}
